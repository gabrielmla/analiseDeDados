...
ggplot(dados.sum.maisGasto, aes(x = reorder(nomeParlamentar, total), y = total, fill = "blue")) +
  geom_bar(stat = "identity") +
  coord_flip() +
  labs("Parlamentares que mais gastam do CEAP", x = "Parlamentar", y = "Valor total gasto")

ggplot(dados.sum.menosGasto, aes(x = reorder(nomeParlamentar, -total), y = total)) +
  geom_bar(stat = "identity", aes(fill = "green")) +
  coord_flip() +
  labs("Parlamentares que menos gastam do CEAP", x = "Parlamentar", y = "Valor total gasto")
```
